...
//------------------------------------------------------------------------------
/**
 * JFrame responsável por representar a interface que listará as assistências
 * inseridas na base de dados, bem como realizar sua edição, remoção e
 * apresentar a interface responsável pela inserção de assistencias
 *
...
public class ListarAssistenciaGUI extends javax.swing.JFrame {
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        InserirAssistenciaGUI iag = new InserirAssistenciaGUI(modelo);

        iag.setLocationRelativeTo(null);
        iag.setVisible(true);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            ...
            InserirAssistenciaGUI itg = new InserirAssistenciaGUI(modelo,
    ...
    private void btDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeletarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            int idFuncao = (int) tabela.getValueAt(linhaSelecionada, 0);
            AssistenciaController fc = new AssistenciaController();
    ...
    private void txPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txPesquisaActionPerformed
        AssistenciaController ac = new AssistenciaController();
        modelo.setNumRows(0);
        for (Assistencia a : ac.pesquisar(txPesquisa.getText())) {
            modelo.addRow(new Object[]{a.getCod(), a.getNmFantasia()});
        }
