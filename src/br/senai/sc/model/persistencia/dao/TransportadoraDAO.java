...
//import br.senai.sc.model.negocio.Transportadora;
//import br.senai.sc.model.persistencia.DAOJPA;
//import br.senai.sc.model.negocio.Transportadora;
//import java.util.List;
//------------------------------------------------------------------------------
/**
...
//--------------------------------------------------------------------------
/**
 * Método responsável pela atualização de uma transportadora na base de dados
 *
 * @author Wesley Batista
 * @since 1.0 09/09/13
 * @param t
...
//--------------------------------------------------------------------------
/**
 * Método responsável pela listagem de todas as transportadoras na base de dados
 *
 * @author Wesley Batista
 * @since 1.0 09/09/13 ,
 * @param
...
//--------------------------------------------------------------------------
/**
 * Método responsável por buscar uma transportadora na base de dados através de
 * um id
 *
 * @author Wesley Batista
 * @since 1.0 09/09/13
...
//}
public interface TransportadoraDAO extends DAO<Transportadora, Integer> {

    List<Transportadora> pesquisaNome(String nome);
}
